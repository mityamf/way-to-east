...
/* harmony import */ var _modules_hotel_preview_slider__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/hotel-preview-slider */ "./js/modules/hotel-preview-slider.js");
/* harmony import */ var _modules_main_comments__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/main-comments */ "./js/modules/main-comments.js");
...
/* harmony import */ var _modules_lightbox__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/lightbox */ "./js/modules/lightbox.js");
/* harmony import */ var _modules_modal__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/modal */ "./js/modules/modal.js");
/* harmony import */ var _modules_hotel_card_slider__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/hotel-card-slider */ "./js/modules/hotel-card-slider.js");
/* harmony import */ var _modules_load_form__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/load-form */ "./js/modules/load-form.js");
/* harmony import */ var _modules_tel_mask__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./modules/tel-mask */ "./js/modules/tel-mask.js");
...
Object(_modules_hotel_preview_slider__WEBPACK_IMPORTED_MODULE_4__["hotelPreviewSlider"])();
Object(_modules_main_comments__WEBPACK_IMPORTED_MODULE_5__["createComments"])();
Object(_modules_read_more__WEBPACK_IMPORTED_MODULE_6__["readMore"])();
Object(_modules_lightbox__WEBPACK_IMPORTED_MODULE_7__["lightBox"])();
Object(_modules_modal__WEBPACK_IMPORTED_MODULE_8__["modal"])();
Object(_modules_hotel_card_slider__WEBPACK_IMPORTED_MODULE_9__["hotelCardSlider"])();
Object(_modules_load_form__WEBPACK_IMPORTED_MODULE_10__["loadForm"])();
Object(_modules_tel_mask__WEBPACK_IMPORTED_MODULE_11__["default"])();

/***/ }),

/***/ "./js/modules/hotel-card-slider.js":
/*!*****************************************!*\
  !*** ./js/modules/hotel-card-slider.js ***!
  \*****************************************/
/*! exports provided: hotelCardSlider */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "hotelCardSlider", function() { return hotelCardSlider; });
var hotelCardSlider = function hotelCardSlider() {
  var hotelsSliders = document.querySelectorAll('.hotel-card__slider');
  ...
  if (hotelsSliders.length !== 0) {
    var createSliders = function createSliders() {
      hotelsSliders.forEach(function (n) {
        var slider = new Swiper(n.querySelector('.swiper-container'), {
          loop: true,
          slidesPerView: 1,
          spaceBetween: 1,
          pagination: {
...
/***/ "./js/modules/hotel-preview-slider.js":
/*!********************************************!*\
  !*** ./js/modules/hotel-preview-slider.js ***!
  \********************************************/
/*! exports provided: hotelPreviewSlider */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "hotelPreviewSlider", function() { return hotelPreviewSlider; });
var hotelPreviewSlider = function hotelPreviewSlider() {
  var hotelsSliders = document.querySelectorAll('.hotel-preview__slider');
...
var REG_NAME = /^[a-z ]+$/i;
var REG_EMAIL = /^[-a-z0-9!#$%&'*+/=?^_`{|}~]+(?:\.[-a-z0-9!#$%&'*+/=?^_`{|}~]+)*@(?:[a-z0-9]([-a-z0-9]{0,61}[a-z0-9])?\.)*(?:aero|arpa|asia|biz|cat|com|coop|edu|gov|info|int|jobs|mil|mobi|museum|name|net|org|pro|tel|travel|[a-z][a-z])$/;
var REG_MESSAGE = /^[^\u0400-\u04FF]+$/;
var MIN_LENGTH = 0;
var MAX_TEL_LENGTH = 16;
...
var loadForm = function loadForm() {
  ...
  var address = form.getAttribute('action');
  var method = form.getAttribute('method');
  var noConnection = form.getAttribute('data-noConnect');
  var sendFormButton = form.querySelector('.form__button');
  var modalSuccess = document.querySelector('.modal-success');
  ...
  var agreement = document.getElementById('accept');

  var checkInput = function checkInput(field, condition) {
    if (field === nameField) {
  ...
  function validate() {
    if (checkInput(nameField, nameField.value.length >= MIN_LENGTH && REG_NAME.test(String(nameField.value))) && checkInput(emailField, emailField.value.length >= MIN_LENGTH && REG_EMAIL.test(String(emailField.value).toLowerCase())) && checkInput(phoneField, phoneField.value.replace(/\D+/g, '').length < MAX_TEL_LENGTH && phoneField.value !== '') && checkInput(messageField, messageField.value.length >= MIN_LENGTH && REG_MESSAGE.test(String(messageField.value))) && checkInput(agreement, agreement.checked)) {
      return true;
    } else {
      return false;
    }
  ...
  function iterateFields(evt) {
    if (evt.target.value.length !== 0) {
      switch (evt.target.id) {
        case 'name-field':
          checkInput(nameField, nameField.value.length >= MIN_LENGTH && REG_NAME.test(String(nameField.value.replace(/\d/, ''))));
          break;
        ...
        case 'phone-field':
          checkInput(phoneField, checkInput(phoneField.value.replace(/\D+/g, '').length < MAX_TEL_LENGTH && phoneField.value !== ''));
          break;
  ...
  var load = function load(url, onSuccess, onError, sent) {
    ...
    xhr.timeout = 5000;
    xhr.open(method, url, true); // xhr.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded');
    // xhr.setRequestHeader('X-Requested-With', 'XMLHttpRequest');

    xhr.send(sent);
  };

  var onSuccess = function onSuccess(responseSuccess) {
    if (responseSuccess) {
      openModalSuccess();
      form.reset();
    }
  ...
  var openModalSuccess = function openModalSuccess() {
...
var createComments = function createComments() {
  var commentsSlider = document.querySelector('.comments__slider');

  if (!commentsSlider) {
    return;
  }

  var commentThumbsProperties = {
    spaceBetween: 0,
    slidesPerView: 'auto',
    slidesOffsetAfter: 0,
    freeMode: false,
  ...
  var commentsThumbsContainer = document.querySelector('.comments .gallery-thumbs');
  var commentsTopContainer = document.querySelector('.comments .gallery-top');

  var createCommentsSwiper = function createCommentsSwiper(thumbsContainer, topContainer) {
    var galleryThumbs = new window.Swiper(thumbsContainer, commentThumbsProperties);
    var galleryTop = new window.Swiper(topContainer, {
      spaceBetween: 0,
      observer: true,
      effect: 'fade',
      fadeEffect: {
...
var mobileMenu = function mobileMenu() {
  ...
  if (header) {
    var openButton = header.querySelector('.main-nav__open-menu');
    var closeButton = header.querySelector('.main-nav__close-menu');
    var wrapper = document.querySelector('.wrapper');
...
var modal = function modal() {
  ...
  var modalSuccess = document.querySelector('.modal-success');
  var modalVideoLink = document.querySelector('.hotel-card__link--video');
  var buttonVideoClose = modalVideo.querySelector('.modal__close-btn');
  var modalVideoOverlay = modalVideo.querySelector('.modal__overlay');
  var buttonSuccessClose = modalSuccess.querySelector('.modal__close-btn');
  var modalSuccessOverlay = modalSuccess.querySelector('.modal__overlay');
  var modalSuccessButton = modalSuccess.querySelector('.modal-success__button');
  var wrapper = document.querySelector('.wrapper');
...
var readMore = function readMore() {
  var readMoreButton = document.querySelector('.hotel-card__button');

  if (!readMoreButton) {
    return;
  }

  var textLong = document.querySelector('.hotel-card__text-wrapper');
...
var setInputMask = function setInputMask() {
  ...
  var setTelMask = function setTelMask() {
    if (inputsTel.length > 0) {
      inputsTel.forEach(function (input) {
        var chooseMask = function chooseMask() {
          var dispatchMask = {};

          var setMask = function setMask() {
            dispatchMask = new imask__WEBPACK_IMPORTED_MODULE_0__["default"](input, {
              mask: [{
                min: 11,
          ...
          var setCaret = function setCaret(evt) {
            if (evt.code === 'Tab') {
